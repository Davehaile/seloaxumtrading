...
export default function WhatsAppButton() {
  ...
  return (
    <div
      className={`fixed bottom-6 z-50 flex items-center gap-3 ${isRTL ? "left-6 flex-row-reverse" : "right-6"}`}
      ...
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="bg-[#075E54] text-white text-sm font-medium px-4 py-2 rounded-full shadow-lg whitespace-nowrap pointer-events-none"
          >
            {TOOLTIP[lang]}
          </motion.div>
        )}
